...
*Arguments*:
  ...
  * **text_parameter_values** = array containing the string values associated with each text parameter. In Python this is optional if parameter_names is a dictionary containing the string values.
...
*Arguments*:
  ...
  * **quantize_nsd** = Number of significant digits or bits. Its use is dependent on the quantization mode used.
    ...
    - 3 (BitRound): The value can be set from 1 to 15 bits for floats or 1 to 52 bits
                    for doubles.
