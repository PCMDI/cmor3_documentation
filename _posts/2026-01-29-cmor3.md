...
* `cmor_setup` in the Fortran API will now allow the use of NetCDF 4 functionality when setting the parameter `netcdf_file_action` with either "preserve_4", "append_4", or "replace_4".
